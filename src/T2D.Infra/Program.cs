...
namespace T2D.Infra
{
	public class Program
	{
		...
		private static void InsertBaseData(EfContext dbc)
		{
			Console.WriteLine("\nCreating data ...");
			//Enums
		...
		private static void InsertServiceRequestData(EfContext dbc)
		{
		}
		...
		private static void AddAttributeData(EfContext dbc, Type enumType)
		{
			...
			SaveIdentityOnData<Entities.Attribute>(dbc);
		}

		private static void SaveIdentityOnData<TEntity>(EfContext dbc)
			where TEntity : class
		{
