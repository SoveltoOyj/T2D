...
namespace InventoryUI.Controllers
{
	public class SessionController : Controller
	{
		...
		{
			ViewData["AccessToken"] = AzureAdB2COptions.Access_Token;
			var handler = new JwtSecurityTokenHandler();
			var tokens = handler.ReadToken(AzureAdB2COptions.Access_Token) as JwtSecurityToken;
			ViewData["Claims"] = tokens.Claims;
			return View();
		}
